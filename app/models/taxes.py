...
from app.constants import DEFAULT_FINANCIAL_YEAR, TaxRegime
...
class EmployeeTaxProfile(Base, TimestampMixin):
    ...
    declared_home_loan_interest: Mapped[Decimal] = mapped_column(_MONEY, default=Decimal("0"), server_default=_ZERO)
    ...
    __table_args__ = (
        UniqueConstraint("employee_id", name="uq_tax_profile_employee"),
    )
