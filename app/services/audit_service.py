...
_RULES: list[tuple[str, re.Pattern[str], str]] = [
    ...
    ("POST", re.compile(rf"^/api/v1/enterprise/payroll/structures$"), "Created salary structure"),
    ...
    ("POST", re.compile(rf"^/api/v1/enterprise/payroll/cycles/{_ID}/email-payslips$"), "Emailed cycle payslips"),
